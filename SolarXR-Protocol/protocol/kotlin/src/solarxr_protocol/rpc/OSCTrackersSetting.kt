...
class OSCTrackersSetting : Table() {
    ...
    companion object {
        ...
        @JvmStatic
        fun createOSCTrackersSetting(builder: FlatBufferBuilder, head: Boolean, chest: Boolean, waist: Boolean, knees: Boolean, feet: Boolean, elbows: Boolean, hands: Boolean, accessory: Boolean) : Int {
            builder.startTable(8)
            addAccessory(builder, accessory)
        ...
        @JvmStatic
        fun addAccessory(builder: FlatBufferBuilder, accessory: Boolean) = builder.addBoolean(7, accessory, false)
        @JvmStatic
