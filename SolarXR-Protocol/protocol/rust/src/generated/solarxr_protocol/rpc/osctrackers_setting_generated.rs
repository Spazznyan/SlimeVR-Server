...
impl<'a> OSCTrackersSetting<'a> {
  ...
  pub const VT_ACCESSORY: flatbuffers::VOffsetT = 18;
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    builder.add_accessory(args.accessory);
  ...
  #[inline]
  pub fn accessory(&self) -> bool {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(OSCTrackersSetting::VT_ACCESSORY, Some(false)).unwrap()}
  }
}
...
impl flatbuffers::Verifiable for OSCTrackersSetting<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<bool>("accessory", Self::VT_ACCESSORY, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b> OSCTrackersSettingBuilder<'a, 'b> {
  ...
  #[inline]
  pub fn add_accessory(&mut self, accessory: bool) {
    self.fbb_.push_slot::<bool>(OSCTrackersSetting::VT_ACCESSORY, accessory, false);
  }
  #[inline]
...
impl core::fmt::Debug for OSCTrackersSetting<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("OSCTrackersSetting");
      ...
      ds.field("accessory", &self.accessory());
      ds.finish()
  }
}
