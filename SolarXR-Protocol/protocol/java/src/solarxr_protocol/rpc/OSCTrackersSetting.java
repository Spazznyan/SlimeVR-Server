...
public final class OSCTrackersSetting extends Table {
  ...
  public boolean accessory() { int o = __offset(18); return o != 0 ? 0!=bb.get(o + bb_pos) : false; }
  ...
  public static void addAccessory(FlatBufferBuilder builder, boolean accessory) { builder.addBoolean(7, accessory, false); }
  ...
  public void unpackTo(OSCTrackersSettingT _o) {
    ...
    _o.setHands(_oHands);
    boolean _oAccessory = accessory();
    _o.setAccessory(_oAccessory);
  }
