...
inline const TrackerRole (&EnumValuesTrackerRole())[23] {
...
inline const char *EnumNameTrackerRole(TrackerRole e) {
  if (flatbuffers::IsOutRange(e, TrackerRole::NONE, TrackerRole::ACCESSORY)) return "";
  const size_t index = static_cast<size_t>(e);
...
inline const char *EnumNameSkeletonBone(SkeletonBone e) {
  if (flatbuffers::IsOutRange(e, SkeletonBone::NONE, SkeletonBone::ACCESSORY)) return "";
  const size_t index = static_cast<size_t>(e);
...
struct OSCTrackersSetting FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool accessory() const {
    return GetField<uint8_t>(VT_ACCESSORY, 0) != 0;
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<uint8_t>(verifier, VT_ELBOWS, 1) &&
           VerifyField<uint8_t>(verifier, VT_HANDS, 1) &&
           VerifyField<uint8_t>(verifier, VT_ACCESSORY, 1) &&
           verifier.EndTable();
  }
};
...
struct OSCTrackersSettingBuilder {
  ...
  void add_accessory(bool accessory) {
    fbb_.AddElement<uint8_t>(OSCTrackersSetting::VT_ACCESSORY, static_cast<uint8_t>(accessory), 0);
  }
