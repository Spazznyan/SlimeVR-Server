...
class HumanSkeleton(
	...
	val leftMiddleProximalBone = Bone(BoneType.LEFT_MIDDLE_PROXIMAL, Constraint(ConstraintType.LOOSE_HINGE, -32f, 95f, 20f))
	val leftMiddleIntermediateBone = Bone(BoneType.LEFT_MIDDLE_INTERMEDIATE, Constraint(ConstraintType.LOOSE_HINGE, -10f, 105f, 0f))
	val leftMiddleDistalBone = Bone(BoneType.LEFT_MIDDLE_DISTAL, Constraint(ConstraintType.LOOSE_HINGE, -10f, 80f, 0f))
	val leftRingProximalBone = Bone(BoneType.LEFT_RING_PROXIMAL, Constraint(ConstraintType.LOOSE_HINGE, -35f, 100f, 20f))
	val leftRingIntermediateBone = Bone(BoneType.LEFT_RING_INTERMEDIATE, Constraint(ConstraintType.LOOSE_HINGE, -10f, 105f, 0f))
	val leftRingDistalBone = Bone(BoneType.LEFT_RING_DISTAL, Constraint(ConstraintType.LOOSE_HINGE, -10f, 80f, 0f))
	val leftLittleProximalBone = Bone(BoneType.LEFT_LITTLE_PROXIMAL, Constraint(ConstraintType.LOOSE_HINGE, -40f, 110f, 20f))
	val leftLittleIntermediateBone = Bone(BoneType.LEFT_LITTLE_INTERMEDIATE, Constraint(ConstraintType.LOOSE_HINGE, -10f, 105f, 0f))
	val leftLittleDistalBone = Bone(BoneType.LEFT_LITTLE_DISTAL, Constraint(ConstraintType.LOOSE_HINGE, -10f, 80f, 0f))
	...
	val rightIndexProximalBone = Bone(BoneType.RIGHT_INDEX_PROXIMAL, Constraint(ConstraintType.LOOSE_HINGE, -30f, 90f, 20f))
	val rightIndexIntermediateBone = Bone(BoneType.RIGHT_INDEX_INTERMEDIATE, Constraint(ConstraintType.LOOSE_HINGE, -10f, 105f, 0f))
	val rightIndexDistalBone = Bone(BoneType.RIGHT_INDEX_DISTAL, Constraint(ConstraintType.LOOSE_HINGE, -10f, 80f, 0f))
	val rightMiddleProximalBone = Bone(BoneType.RIGHT_MIDDLE_PROXIMAL, Constraint(ConstraintType.LOOSE_HINGE, -32f, 95f, 20f))
	val rightMiddleIntermediateBone = Bone(BoneType.RIGHT_MIDDLE_INTERMEDIATE, Constraint(ConstraintType.LOOSE_HINGE, -10f, 105f, 0f))
	val rightMiddleDistalBone = Bone(BoneType.RIGHT_MIDDLE_DISTAL, Constraint(ConstraintType.LOOSE_HINGE, -10f, 80f, 0f))
	val rightRingProximalBone = Bone(BoneType.RIGHT_RING_PROXIMAL, Constraint(ConstraintType.LOOSE_HINGE, -35f, 100f, 20f))
	val rightRingIntermediateBone = Bone(BoneType.RIGHT_RING_INTERMEDIATE, Constraint(ConstraintType.LOOSE_HINGE, -10f, 105f, 0f))
	val rightRingDistalBone = Bone(BoneType.RIGHT_RING_DISTAL, Constraint(ConstraintType.LOOSE_HINGE, -10f, 80f, 0f))
	val rightLittleProximalBone = Bone(BoneType.RIGHT_LITTLE_PROXIMAL, Constraint(ConstraintType.LOOSE_HINGE, -40f, 110f, 20f))
	val rightLittleIntermediateBone = Bone(BoneType.RIGHT_LITTLE_INTERMEDIATE, Constraint(ConstraintType.LOOSE_HINGE, -10f, 105f, 0f))
	val rightLittleDistalBone = Bone(BoneType.RIGHT_LITTLE_DISTAL, Constraint(ConstraintType.LOOSE_HINGE, -10f, 80f, 0f))
