...
class HumanSkeleton(
	...
	val leftRingProximalBone = Bone(BoneType.LEFT_RING_PROXIMAL, Constraint(ConstraintType.LOOSE_HINGE, -30f, 90f, 20f))
	...
	val leftLittleProximalBone = Bone(BoneType.LEFT_LITTLE_PROXIMAL, Constraint(ConstraintType.LOOSE_HINGE, -30f, 90f, 20f))
	...
	val rightMiddleProximalBone = Bone(BoneType.RIGHT_MIDDLE_PROXIMAL, Constraint(ConstraintType.LOOSE_HINGE, -30f, 90f, 20f))
	...
	val rightRingProximalBone = Bone(BoneType.RIGHT_RING_PROXIMAL, Constraint(ConstraintType.LOOSE_HINGE, -30f, 90f, 20f))
	...
	val rightLittleProximalBone = Bone(BoneType.RIGHT_LITTLE_PROXIMAL, Constraint(ConstraintType.LOOSE_HINGE, -30f, 90f, 20f))
